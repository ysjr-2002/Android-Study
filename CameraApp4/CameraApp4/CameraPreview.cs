...
{
    //[Activity(Label = "CameraApp4", MainLauncher = true, Icon = "@drawable/icon")]
    [Activity(Label = "Graphics/Camera Preview", MainLauncher = false,ScreenOrientation = Android.Content.PM.ScreenOrientation.Landscape)]
    //[IntentFilter(new[] { Intent.ActionMain }, Categories = new string[] { "简单分类" })]
